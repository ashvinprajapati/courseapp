              ...
              >
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="text-center">
                    ...
                    {/* Video/Download Button if available */}
                    {purchase.videoLink && (
                      <div className="mt-4">
                        <a
                          href={purchase.videoLink}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-block px-4 py-2 mt-2 bg-blue-500 text-white text-sm rounded hover:bg-blue-600 transition"
                        >
                          Watch Video
                        </a>
                      </div>
