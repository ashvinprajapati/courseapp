...
function Courses() {
  ...
  return (
    <div className="flex h-screen">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-gray-100 p-5 z-20 transform transition-transform duration-300 ease-in-out ${
      ...
      {/* Main Content */}
      <main className="flex-1 bg-white p-6 md:pl-64 overflow-y-auto">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {courses.map((course) => (
                ...
                >
                  ...
                  <Link
                    to={`/buy/${course._id}`}
                    className="bg-orange-500 w-full text-white px-4 py-2 rounded-lg hover:bg-blue-900 transition-colors"
                  >
                    Buy Now
                  </Link>
                </div>
